    ...
    <div className="rounded-2xl bg-white p-4 border border-gray-100 sm:p-5">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="text-right flex-shrink-0">
          <span className="text-xs text-gray-400 sm:text-sm">{formatDistance(distance_km)}</span>
          <p className={`text-lg font-semibold mt-1 sm:text-xl ${stockColors[stockStatus]}`}>
            {quantity}
          </p>
          <span className="text-[10px] text-gray-400 sm:text-xs">ชิ้น</span>
        </div>
      </div>
      ...
      <button
        ...
        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-gray-900 py-3 font-medium text-white transition-colors hover:bg-gray-800 active:bg-gray-700 min-h-[48px] text-sm sm:text-base"
      >
